        ...
        <div class="col-sm-6">
            ...
            <div class="post post-list-sm square before-seperator">
                <div class="thumb rounded">
                    <a href="blog-single.html">
                        <div class="inner">
                            <img src="{{ asset('/front/images/posts/trending-sm-1.jpg') }}"
                                alt="post-title" />
                        </div>
                    </a>
                </div>
            ...
            <div class="post post-list-sm square before-seperator">
                <div class="thumb rounded">
                    <a href="blog-single.html">
                        <div class="inner">
                            <img src="{{ asset('/front/images/posts/trending-sm-2.jpg') }}"
                                alt="post-title" />
                        </div>
                    </a>
                </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="post">
                <div class="thumb rounded">
                    ...
                    <a href="blog-single.html">
                        <div class="inner">
                            <img src="{{ asset('/front/images/posts/trending-lg-2.jpg') }}"
                                alt="post-title" />
                        </div>
                    </a>
                </div>
            ...
            <div class="post post-list-sm square before-seperator">
                <div class="thumb rounded">
                    <a href="blog-single.html">
                        <div class="inner">
                            <img src="{{ asset('/front/images/posts/trending-sm-3.jpg') }}"
                                alt="post-title" />
                        </div>
                    </a>
                </div>
            ...
            <div class="post post-list-sm square before-seperator">
                <div class="thumb rounded">
                    <a href="blog-single.html">
                        <div class="inner">
                            <img src="{{ asset('/front/images/posts/trending-sm-4.jpg') }}"
                                alt="post-title" />
                        </div>
                    </a>
                </div>

    ...
    <div class="post post-single">
        ...
        <div class="post-header">
            ...
            <ul class="meta list-inline mb-0">
                <li class="list-inline-item"><a href="#"><img src="{{ asset('/front/images/other/author-sm.png') }}"
        ...
        <div class="featured-image">
            <img src="{{ asset('/front/images/posts/featured-lg.jpg') }}" alt="post-title" />
        </div>
        <!-- post content -->
        <div class="post-content clearfix">
            <p>The European languages are members of the same family. Their separate existence is a myth. For
                science, music, sport, etc, Europe uses the same <a href="#">vocabulary</a>. The languages
            ...
            <p>Everyone realizes why a new common language would be desirable: one could refuse to pay expensive
                translators. To achieve this, it <mark>would be</mark> necessary to have uniform grammar,
                pronunciation and more common words.</p>

            <figure class="figure">
                <img src="{{ asset('/front/images/posts/post-lg-2.jpg') }}" class="figure-img img-fluid rounded"
                    alt="...">
            ...
            <img src="{{ asset('/front/images/posts/single-sm-1.jpg') }}" class="rounded alignleft" alt="...">
            <p>One could refuse to pay expensive translators. To achieve this, it would be necessary to have
            ...
            <p>If several languages coalesce, the grammar of the resulting language is more simple and regular
                ...
                than the existing <a href="#">European languages</a>. It will be as simple as Occidental;
                in fact, it will be Occidental.</p>
            ...
            <p>To an English person, it will seem like simplified <a href="#">English</a>, as a skeptical
    ...
    <div class="comments bordered padding-30 rounded">
        ...
        <ul class="comments">
            ...
            <li class="comment rounded">
                <div class="thumb">
                    <img src="{{ asset('/front/images/other/comment-1.png') }}" alt="John Doe" />
                </div>
                <div class="details">
            ...
            <li class="comment rounded">
                <div class="thumb">
                    <img src="{{ asset('/front/images/other/comment-3.png') }}" alt="John Doe" />
                </div>
                <div class="details">
                    <h4 class="name"><a href="#">Anna Doe</a></h4>
                    <span class="date">Jan 08, 2021 14:41 pm</span>
                    <p>Cras ultricies mi eu turpis hendrerit fringilla. Vestibulum ante ipsum primis in faucibus
